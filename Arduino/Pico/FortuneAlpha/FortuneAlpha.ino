...
void readSensorsPrint()
{
    ...
    rpm_val = 123;
    time_passed = 456;
    delay(1000); // faux delay for mimicing rotation                                   
}
...
void readSensorsDisplay()
{
    ...
    // time_passed = ((hall_end-hall_start)/1000000.0);  // converts microseconds to seconds 
    // rpm_val = ((hall_count-1) / time_passed) * 60.0;  //converts seconds to minutes                                   
    time_passed = 789;  // converts microseconds to seconds 
    rpm_val = 112233;  //converts seconds to minutes
}
...
void printTemp()
{
    ...
    Serial.println(temp_end - temp_start);
